...
object BronzeWeatherCheck {
  ...
  def checkBronzeWeather(spark: SparkSession, bronzeWeatherPath: String): Unit = {
    ...
    val keyFields = Seq(
      ...
      "DewPointFarenheit", "DewPointCelsius", "RelativeHumidity",
      "WindSpeed", "WindDirection", "Altimeter", 
      "SeaLevelPressure", "StationPressure", "HourlyPrecip",
      "SkyCondition", "WeatherType"
    )
