...
object ModelingPipeline {
   ...
   *
   * @param extraNumCols liste des colonnes numériques météo à inclure (peut être vide)
   * @param ds identifiant du dataset (D1..D4)
   * @param th seuil de retard (15, 30, 45, 60, 90)
   */
  ...
  def trainAndEvaluate(
    ...
    try {
      ...
      val assembler = model.stages.collect {
        case a: VectorAssembler => a
      }.head
